...
export function DictationFab() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-28 md:bottom-6 right-6 w-14 h-14 bg-indigo-500 hover:bg-indigo-600 rounded-full shadow-lg shadow-indigo-500/30 flex items-center justify-center text-white transition-transform hover:scale-110 z-50"
  ...
  return (
    <div className="fixed bottom-28 md:bottom-6 right-6 w-80 max-w-[calc(100vw-3rem)] bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl z-50 overflow-hidden flex flex-col">
